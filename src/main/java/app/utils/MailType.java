...
public enum MailType {
    ...
    public String getMailTemplate(String username) {
        switch (this) {
            case WELCOME:
                return getTemplate(username, "https://k60.kn3.net/9/9/2/5/1/3/800.jpg");
    ...
    public String getTemplate(String username, String photoUrl) {
        return "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><!--[if IE]><html xmlns=\"http://www.w3.org/1999/xhtml\" class=\"ie\"><![endif]--><!--[if !IE]><!--><html style=\"margin: 0;padding: 0;\" xmlns=\"http://www.w3.org/1999/xhtml\"><!--<![endif]--><head>\n" +
                ...
                "            \n" +
                "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\n" +
                "      <h1 class=\"size-64\" style=\"Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #000;font-size: 44px;line-height: 50px;font-family: avenir,sans-serif;text-align: center;\" lang=\"x-size-64\"><span class=\"font-avenir\"><strong><span style=\"color:#ffffff\">" + getMailText() + " " + username + "!</span></strong></span></h1>\n" +
                "    </div>\n" +
                "            \n" +
                "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\n" +
