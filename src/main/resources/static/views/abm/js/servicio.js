        ...
        <div id="add-listing">
            ...
            <div class="add-listing-section">
                ...
                <div class="add-listing-headline">
                    <h3><i class="sl sl-icon-doc"></i>Servicios</h3>
                </div>
                <!-- Form -->
                <div class="row">
                    <div v-if="formPost">
                        <form v-on:submit.prevent='postItem()'>
                            <div class="col-md-10 col-sm-12">
                                <div>
                                    <input type="text" v-model="item.nombre" placeholder="Servicio"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div>
                                    <button type="submit" class="button medium border"><i
                                            class="sl sl-icon-plus"></i> Nueva Servicio
                                    </button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div v-else>
                        <form v-on:submit='editItem()'>
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div>
                                    <button type="submit" class="button medium border"><i
                                            class="sl sl-icon-note"></i> Editar Servicio
                                    </button>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
    ...
    methods: {
        ...
        postItem() {
            ...
            axios.post(this.url, payload)
                .then((response) => {
                    ...
                    this.item.nombre = '';
                    sweetAlert("Guardado!", "Nueva Servicio creada exitosamente.", "success");
                })
                .catch(error => {
                        console.log(error);
                        sweetAlert("Oops...", "Error, ver consola", "error");
        ...
        editItem() {
            ...
            axios.put(this.url + '/' + this.item.id, payload)
                .then((response) => {
                    ...
                    sweetAlert("Editado!", "Servicio editada exitosamente.", "success");
        ...
        deleteItem(index) {
            ...
            axios.delete(this.url + '/' + id)
                .then((response) => {
                    sweetAlert("Eliminada!", "Servicio eliminada correctamente.", "success");
        ...
        deleteItemActionButton(index) {
            ...
            sweetAlert({
                    ...
                    text: "Quiere eliminar la Servicio con id: " + id + " ?",
                    type: "warning",
                ...
                function () {
                    vm.$refs.myServicio.$refs.currentView.deleteItem(index, id)
                });
        },
        editItemButtonUndo() {
            this.formPost = true;
