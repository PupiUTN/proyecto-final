        ...
        <div id="add-listing">
            ...
            <div class="add-listing-section">
                ...
                <div class="add-listing-headline">
                    <h3><i class="sl sl-icon-doc"></i>vacuna</h3>
                </div>
                <!-- Form -->
                <div class="row">
                    <div v-if="formPost">
                        <form v-on:submit.prevent='postItem()'>
                            <div class="col-md-10 col-sm-12">
                                <div>
                                    <input type="text" v-model="item.nombre" placeholder="Vacuna"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
                                <div>
                                    <button type="submit" class="button medium border"><i
                                            class="sl sl-icon-plus"></i> Nueva Vacuna
                                    </button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div v-else>
                        <form v-on:submit='editItem()'>
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div>
                                    <button type="submit" class="button medium border"><i
                                            class="sl sl-icon-note"></i> Editar Vacuna
                                    </button>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-12">
    ...
    methods: {
        ...
        deleteItem(index) {
            ...
            axios.delete(this.url + '/' + id)
                .then((response) => {
                    sweetAlert("Eliminada!", "Vacuna eliminada correctamente.", "success");
        ...
        deleteItemActionButton(index) {
            ...
            sweetAlert({
                    ...
                    text: "Quiere eliminar la Vacuna con id: " + id + " ?",
                    type: "warning",
                ...
                function () {
                    vm.$refs.myVacuna.$refs.currentView.deleteItem(index, id)
                });
        },
        editItemButtonUndo() {
            this.formPost = true;
