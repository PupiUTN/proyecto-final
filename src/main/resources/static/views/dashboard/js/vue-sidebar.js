        ...
        <div class="dashboard-nav">
            <div class="dashboard-nav-inner">
                ...
                <ul v-show="role === 'ROLE_USER' || role === 'ROLE_CUIDADOR'"  data-submenu-title="Cuenta">
					...
					<ul>
						<li><a href="/views/reserva/mis-reservas-user.html?status=CONFIRMATION_PENDING">Pendientes </a></li>
						<li><a href="/views/reserva/mis-reservas-user.html?status=ACCEPTED">Aceptadas </a></li>
						<li><a href="/views/reserva/mis-reservas-user.html?status=CANCEL_BY_USER">Canceladas </a></li>
						<li><a href="/views/reserva/mis-reservas-user.html?status=PAID">Pagadas </a></li>
					</ul>
                ...
                <ul  data-submenu-title="Cuidador">
                    <li v-show="role === 'ROLE_USER' || role === 'ROLE_CUIDADOR'"><a href="/views/cuidadores/alta-cuidador.html"><i class="sl sl-icon-user"></i> Solicitud</a></li>
					 ...
					 <ul>
						<li><a href="/views/reserva/mis-reservas-cuidador.html?status=CONFIRMATION_PENDING">Pendientes</a></li>
						<li><a href="/views/reserva/mis-reservas-cuidador.html?status=ACCEPTED">Aceptadas</a></li>
						<li><a href="/views/reserva/mis-reservas-cuidador.html?status=CANCEL">Canceladas</a></li>
						<li><a href="/views/reserva/mis-reservas-cuidador.html?status=PAID">Pagadas</a></li>
					 </ul>	
					 </li>
                </ul>
