    ...
    template: `
        <div class="dashboard-nav">
            <div class="dashboard-nav-inner">
                ...
                <ul v-if="role === 'ROLE_USER'"  data-submenu-title="Cuenta">
                ...
                <ul v-if="role === 'ROLE_CUIDADOR'" data-submenu-title="Cuidador">
                ...
                <ul v-if="role === 'ROLE_ADMIN'" data-submenu-title="Admin" >
